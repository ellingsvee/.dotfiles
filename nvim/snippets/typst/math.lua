...
local function in_mathzone()
  ...
  -- Convert cursor position (Lua 1-based to LSP 0-based)
  params.position = { line = params.position[1] - 1, character = params.position[2] }

  -- Make an LSP request to Tinymist
  local result = vim.lsp.buf_request_sync(0, "tinymist/interactCodeContext", {
    query = { { kind = "modeAt", position = params.position } },
  }, 500) -- 500ms timeout
  ...
  for _, res in pairs(result) do
    if res.result and res.result[1] and res.result[1].mode == "math" then
      return true
    end
  end
...
M = {
  ...
  --
  -- s({ trig = 'mc', name = 'Calligraphic math font', snippetType = 'autosnippet', wordTrig = false }, {
  --   f(function(_, snip)
  ...
  -- --
  -- s({ trig = 'mr', name = 'Roman math font', snippetType = 'autosnippet', wordTrig = false }, {
  --   f(function(_, snip)
  --     return snip.captures[1]
  --   end),
  --   t '\\mathrm{',
  ...
  -- }, { condition = in_mathzone }),
  -- --
  s({ trig = "bf", name = "Bold math font", snippetType = "autosnippet" }, {
    f(function(_, snip)
      return snip.captures[1]
    end),
    t("\\mathbf{"),
  ...
  -- s({ trig = 'bs', name = 'Bold symbol', snippetType = 'autosnippet' }, {
  --   f(function(_, snip)
  --     return snip.captures[1]
  --   end),
  --   t '\\boldsymbol{',
  ...
  --
  s({ trig = "mk", name = "Inline display", snippetType = "autosnippet", wordTrig = false }, {
    f(function(_, snip)
      return snip.captures[1]
    end),
    t("$"),
  ...
  -- -- ),
  -- --
  -- s({ trig = 'tx', name = 'Text inside display', snippetType = 'autosnippet', wordTrig = false }, {
  --   f(function(_, snip)
  --     return snip.captures[1]
  --   end),
  --   t '\\text{',
  ...
  --   end),
  --   t("^T"),
  -- }, { condition = in_typst_mathzone }),
  -- s({ trig = 'inv', name = 'Inverse', snippetType = 'autosnippet' }, {
  --   f(function(_, snip)
  --     return snip.captures[1]
  --   end),
  --   t '^{-1}',
  ...
  -- -- ),
  -- --
  -- s({ trig = 'fr', name = 'Fraction', snippetType = 'autosnippet' }, {
  --   f(function(_, snip)
  --     return snip.captures[1]
  --   end),
  --   c(1, {
  ...
  -- -- ),
  -- --
  -- -- s({ trig = 'sim', name = 'Relation', snippetType = 'autosnippet' }, {
  -- --   f(function(_, snip)
  -- --     return snip.captures[1]
  -- --   end),
  -- --   c(1, {
  ...
  -- -- }, { condition = in_mathzone }),
  -- --
  -- s({ trig = 'sim', name = 'sim', snippetType = 'autosnippet', wordTrig = false }, {
  --   f(function(_, snip)
  --     return snip.captures[1]
  --   end),
  --   t '\\sim',
  ...
  -- }, { condition = in_mathzone }),
  --
  -- -- s({trig = "inf", name = "Infimum", snippetType = "autosnippet"},
  -- --     {
  -- -- 		f(function(_,snip) return snip.captures[1] end),
  -- --         c(1,
  -- --             {
  ...
  -- -- ),
  -- --
  -- s({ trig = 'inf', name = 'Infinity', snippetType = 'autosnippet' }, {
  --   f(function(_, snip)
  --     return snip.captures[1]
  --   end),
  --   t '\\infty',
  ...
  -- -- -- Sets and inclusion
  -- --
  -- s({ trig = 'inn', name = 'Belongs to', snippetType = 'autosnippet' }, {
  --   f(function(_, snip)
  --     return snip.captures[1]
  --   end),
  --   t '\\in',
  ...
  -- -- ),
  -- --
  -- s({ trig = 'cup', name = 'Union', snippetType = 'autosnippet' }, {
  --   f(function(_, snip)
  --     return snip.captures[1]
  --   end),
  --   t '\\cup',
  ...
  -- -- ),
  -- --
  -- s({ trig = 'cap', name = 'Intersection', snippetType = 'autosnippet' }, {
  --   f(function(_, snip)
  --     return snip.captures[1]
  --   end),
  --   t '\\cap',
  ...
  -- -- ),
  -- --
  -- -- s({ trig = 'inn', name = 'In', snippetType = 'autosnippet', wordTrig = false }, {
  -- --   f(function(_, snip)
  -- --     return snip.captures[1]
  -- --   end),
  -- --   t '\\in',
  -- -- }, { condition = in_mathzone }),
  --
  -- s({ trig = 'sbs', name = 'Subset', snippetType = 'autosnippet', wordTrig = false }, {
  --   f(function(_, snip)
  --     return snip.captures[1]
  --   end),
  --   t '\\subset',
  -- }, { condition = in_mathzone }),
  --
  -- s({ trig = 'sbq', name = 'Subset or equals', snippetType = 'autosnippet', wordTrig = false }, {
  --   f(function(_, snip)
  --     return snip.captures[1]
  --   end),
  --   c(1, {
...
--   table.insert(
--     M,
--     s({ trig = '[.]' .. trig, name = latex, snippetType = 'autosnippet', regTrig = true, wordTrig = false }, {
--       f(function(_, snip)
--         return snip.captures[1]
--       end),
--       t('\\' .. latex),
...
--   )
--
--   -- uppercase — optional, many are undefined in base LaTeX
--   local upper = latex:sub(1, 1):upper() .. latex:sub(2)
--   table.insert(
--     M,
--     s({ trig = '[.]' .. trig:upper(), name = upper, snippetType = 'autosnippet', regTrig = true, wordTrig = false }, {
--       f(function(_, snip)
--         return snip.captures[1]
--       end),
--       t('\\' .. upper),
...
--     M,
--     s({
--       trig = trig:sub(1, 1):upper() .. trig:sub(2),
--       name = upper,
